...
public class StandardAutoCompleteSignInActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        Log.d(TAG,"onResume StandardAuto...");
    ...
    protected void onPause() {
        super.onPause();
        Log.d(TAG,"onPause StandardAuto...");
            ...
            if (view instanceof AutoCompleteTextView) {
                switch (event) {
                    ...
                    case AutofillManager.AutofillCallback.EVENT_INPUT_HIDDEN:
                        Log.d(TAG,"onPause StandardAuto... mAutofillReceived: "+mAutofillReceived);
                    ...
                    case AutofillManager.AutofillCallback.EVENT_INPUT_SHOWN:
                        ...
                        Log.d(TAG,"onPause StandardAuto... EVENT_INPUT_SHOWN: ");
